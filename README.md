...
(
  ...
  debtor_account                    VARCHAR(35)        NOT NULL,
  creditor_name                     VARCHAR(100)       NOT NULL,
  creditor_account                  VARCHAR(35)        NOT NULL,
  debtor_bank_verification_number   VARCHAR(20),
  creditor_bank_verification_number VARCHAR(20),
  charges_amount                    DECIMAL,
  instructed_amount                 DECIMAL,
  name_enquiry_reference            CHAR(30),
